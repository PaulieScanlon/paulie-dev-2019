...
I've also included a bonus / Gatsby recommend method approach to handling dates. This however is dependant on where
you're souring data and if you're able to query the date using GraphQL.
...
problem entirely as dates are rendered at build time and statically returned as a string.
