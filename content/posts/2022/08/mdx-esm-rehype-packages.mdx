...
date: 2022-08-18
author: Paul Scanlon
featuredImage: https://res.cloudinary.com/www-paulie-dev/image/upload/v1660808390/paulie.dev/2022/08/mdx-esm-rehyp_duw4ps.jpg
---

Hey, in this post i'm going to show you how to use the latest ESM [rehype](https://github.com/rehypejs) plugins with
`gatsby-plugin-mdx` **v3**.

## Titus Wooorm

Before we get started i'd like to introduce Titus Wooorm.

- Twitter: [@wooorm](https://twitter.com/wooorm)
...
The above two packages are quite commonly used in Gatsby sites to enabled click-able headings in blog posts either
written in [Markdown](https://www.markdownguide.org/basic-syntax/) or [MDX](https://mdxjs.com/). In ths post i'll be
talking about how to use them with MDX, but the steps are similar for Markdown.
...
_This will work when using the following package versions._
...
Currently `gatsby-config.js` doesn't support ESM module syntax out of the box, but there is a way to use ESM modules
with Gatsby.
...
if you have attempted to use this unsuccessfully, please do drop a comment below and let me know which package and
version of that package you were using. Thanks in advance!

## Further Reading

As of Aug 17th 2022 Gatsby released v4 of the MDX Plugin. You can read more about how to migrate from v3 to bv4 in docs.
