...
embeddedImages:
  - https://res.cloudinary.com/www-paulie-dev/image/upload/v1677264604/paulie.dev/2023/02/edge-locations-image-1_iajbe1.jpg
  - https://res.cloudinary.com/www-paulie-dev/image/upload/v1677264604/paulie.dev/2023/02/edge-locations-image-2_nxmbpq.jpg
---

Hello there! In November 2022 I started a new role at [Cockroach Labs](https://www.cockroachlabs.com/). I'm now what
we're currently calling a Technical Evidence Engineer — And I'll now try and explain what that means and a little more
...
<GatsbyImage image={props.embedded.image2} alt="Edge Functions Limitations" />
