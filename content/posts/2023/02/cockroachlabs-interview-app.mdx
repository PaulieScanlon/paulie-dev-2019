...
have teams to build websites, you just kind of did everything yourself. This has stuck with me throughout my career and
jobs that have made me unhappy are the jobs that required me to only write the code.

## I Like Writing Code

And I do, but I also like doing other things. I like Design, I like Illustration, Branding, Animation, Motion Graphics,
Art Direction and Copy Writing, and Content Creation, which normally requires I use all of the above. But in more recent
years I've been eager to dust off my Advertising skills. I did a little bit of this when I was at
[Gatsby](https://www.gatsbyjs.com/) but working to a release cycle of every two weeks (because that's how often the
minor framework updates were released), I rarely had more than a few weeks to put something together. That wasn't the
reason I left though. I left because I'm looking to make a permanent move to the USA, and Gatsby as a fully remote
company probably wouldn't have been able to offer this. That said, they've just been aquired by Netlify so 🤷‍♂️. Although,
I'd imagine providing US visa sponsorship to existing employees wouldn't have been at the top of anyone's to do list and
could have delayed my plans to move... anyway, best of luck to the team, you're all the best! 💜
...
ramp my production value up! I don't wanna make shitty looking demo apps that look like they've been made by an Engineer
or create low-fi Tik-Tok style video content with the crazy-face YouTube thumbnails (🤮). I can't do it, I have a
background in Advertising, delivery is everything!
...
Managment (PMM) Team and am taksed with developing new "go to market" deliverables. To do this I'll need to call on my
whole skill set, this could be content creation, it could be demo apps, it might be motion graphics — who knows! The
first two projects I'm working on don't even use the database but promote the buiness benefits of CockroachDB's
distributed capabilities... how do you write code to demo that?
...
I spent around 2 days designing and building this demo app which I called
...
This is actually a problem that plauged me throughout my time at Gatsby. Whenever I needed to create a CMS Demo i'd have
...
interviewers to submit their location while we were talking.

### How Edge Works

Clicking the submit button calls a serverless function, which grabs the `ip` address from the `req` object. It then uses
the `ip` to find the geographical location and sends the latitude and longtitude to a CockroachDB database. The
locations retrieved aren't actually your location but they are the location of where the serverless function has been
deployed. Or to put it another way, they are the locations of **Vercel's Global Edge Network**.
