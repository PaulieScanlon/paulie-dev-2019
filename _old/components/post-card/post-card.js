...
export const PostCard = ({ title, featuredImage, tags, date, dateModified, excerpt, slug, pinned }) => {
  return (
    <Box
      sx={{
        display: 'flex',
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {featuredImage ? (
              <GatsbyImage alt={title} image={getImage(featuredImage.childImageSharp.gatsbyImageData)} />
            ) : null}
          </Box>
          <Box
            sx={{
