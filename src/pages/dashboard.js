...
const Page = ({
  ...
  serverData: {
    serverResponse: { reactions, locations, latest, uaLocations }
  }
}) => {
      ...
      <div className="grid gap-24">
        ...
        <section className="grid sm:grid-cols-2 gap-8">
          <div>
            ...
            <ul className="m-0 p-0 h-[385px] rounded border border-outline bg-surface/70 px-4 sm:px-6 py-6 min-h-[200px]">
              {locations
          ...
          <div>
            ...
            <div className="w-full h-[385px] rounded border border-outline cursor-move">
              <ThreeScene locations={uaLocations.data} />
            </div>
            <div className="mt-2 leading-tight">
              <div className="leading-tight">
                <small className="text-slate-400 text-xs">Data from </small>
...
export async function getServerData() {
  ...
  const allLatLongGoogleUa = require('../utils/get-lat-long-google-ua.util');
  ...
  const uaLocations = await allLatLongGoogleUa.get();
