...
[createNode](https://www.gatsbyjs.com/docs/reference/config-files/actions/#createNode). This is how you add data to the
Redux state object / Gatsby's data layer
