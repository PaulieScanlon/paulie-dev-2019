...
I'm sure i've implemented a number of other CSS selector "hacks" on projects but I can't think of any more right now.
I'll endeavour to update this post as and when any new ones come to mind.
