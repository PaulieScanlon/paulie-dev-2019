...
date: 2020-07-06
author: Paul Scanlon
featuredImageUrl: https://res.cloudinary.com/www-paulie-dev/image/upload/v1595915607/paulie.dev/2020/07/everythings-a-box_vrnzgx.jpg
---
...
The Box is technically just a div but if you inspect the below you'll see there's a few things Theme UI does for us
which will save us time later.
