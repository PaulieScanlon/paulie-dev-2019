...
date: 2020-05-04
author: Paul Scanlon
featuredImage: gatsby-recipe-storybook-ts.jpg
---
...
In short regardless of if you're using JavaScript or TypeScript a Webpack config is required for both `js|jsx` and `ts|tsx`
