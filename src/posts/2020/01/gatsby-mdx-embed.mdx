...
author: Paul Scanlon
embeddedImageUrls:
  - https://res.cloudinary.com/www-paulie-dev/image/upload/v1595915602/paulie.dev/2020/01/gatsby-mdx-embed-image1_oysd3m.jpg
---
...
[gatsby-mdx-embed](https://gatsby-mdx-embed.netlify.com/) works by wrapping the root element of your site or blog with a custom `MdxProvider` which makes it possible for embed codes like this 👇
...
These media provider embed codes usually require you to add some kind of `JavaScript` to your page which can be really tricky to set up, but with this plugin all you need to do is [install](https://github.com/PaulieScanlon/gatsby-mdx-embed#-getting-started) it...
...
There's currently 22 components to choose from and more are on the way so head on over to [gatsby-mdx-embed](https://gatsby-mdx-embed.netlify.app/) and if you can please do give it a star ⭐ on [GitHub](https://github.com/PaulieScanlon/gatsby-mdx-embed)

<Image src={props.embedded.image1.url} />

This plugin was inspired by [gatsby-remark-oembed](https://github.com/raae/gatsby-remark-oembed) which similarly provides an easy way to embed media from providers like YouTube, Twitter, etc into your blog **without import**. However this plugin only works with markdown.
