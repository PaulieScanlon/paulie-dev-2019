...
The first step is to make sure you're able to pass the `backgroundColor` and `width` props through the styled component and on to the function. As mentioned above I prefer to use the _style object_ syntax because I find it easier to destructure the props and to spread the return of the `createMediaQueries` function into the styles 🕺
