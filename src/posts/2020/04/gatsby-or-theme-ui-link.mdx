...
The problem is that [Gatsby](https://www.gatsbyjs.org/docs/gatsby-link/) and [@theme-ui/components](https://theme-ui.com/components/link) both have a component called Link.
