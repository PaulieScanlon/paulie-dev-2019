...
author: Paul Scanlon
featuredImage: intersection-observer.jpg
---

Recently at work i was asked to create a scroll-jacking sticky nav and after trying out numerous open source projects [react-visibility-sensor](https://github.com/joshwnj/react-visibility-sensor), [use-scroll-position](https://github.com/n8tb1t/use-scroll-position) and [react-scrollmagic](https://github.com/bitworking/react-scrollmagic) to name a few i settled on rolling my own using React, vanilla JavaScript and the [Intersection Observer API](https://developer.mozilla.org/en-us/docs/web/api/intersection_observer_api)
